...
namespace WSPack.VisualStudio.Shared.Commands
{
  ...
  internal sealed class OpenOutputPathCommand : OpenOutputPathBaseCommand
  {
    ...
    /// </summary>
    public override int CommandId => CommandIds.OpenOutputPath;
    ...
    protected OpenOutputPathCommand(AsyncPackage package, OleMenuCommandService commandService)
    ...
    /// </summary>
    public static OpenOutputPathCommand Instance { get; private set; }
