...
namespace WSPack.VisualStudio.Shared.Commands
{
  ...
  internal sealed class CopyServerPathSolutionExplorerCommand : CopyServerPathBaseCommand
  {
    ...
    protected CopyServerPathSolutionExplorerCommand(AsyncPackage package, OleMenuCommandService commandService)
    ...
    public override string GetServerItem()
    {
      ...
      if (string.IsNullOrEmpty(item.LocalItem))
        Utils.LogOutputMessage(true, ResourcesLib.StrNaoFoiPossivelRecuperarCaminhoLocalItem);
      else
      {
