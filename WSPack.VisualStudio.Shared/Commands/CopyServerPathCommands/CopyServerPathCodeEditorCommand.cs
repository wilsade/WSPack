...
{
  /// <summary>
  /// Comando para copiar o caminho server de um item
  /// </summary>
  internal sealed class CopyServerPathCodeEditorCommand : CopyServerPathBaseCommand
  {
    /// <summary>
    /// Identificador do comando
    /// </summary>
    public override int CommandId => CommandIds.CopyServerPath;
    ...
    protected CopyServerPathCodeEditorCommand(AsyncPackage package, OleMenuCommandService commandService)
    ...
    /// </summary>
    public static CopyServerPathCodeEditorCommand Instance { get; private set; }
    ...
    public static async Task InitializeAsync(AsyncPackage package, OleMenuCommandService commandService)
    {
      ...
      Instance = new CopyServerPathCodeEditorCommand(package, commandService);
    }
    ...
    {
      var lstWorkspaceLocalItem = CopyLocalPathCodeEditorCommand.Instance.GetLocalItem();
